			...
			<!-- /inner_content-->
				...
				<div class="w3l-table-info agile_info_shadow">
				 ...
				 <h3>Mpesa payments</h3>
				  <input type="text" id="myInput"  placeholder="Search for account name.." title="Type in a name">
				<button type="button" class="btn btn-info btn-flat btn-pri " ><i class="fa fa-print" aria-hidden="true" ></i><a href="print_payments.php" class="btn-info"><i class="fa fa-print" aria-hidden="true" ></i>Print report</a>
                </button>

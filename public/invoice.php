					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								<li><a href="track.php"> <i class="fa fa-tachometer"></i> track</a></li>
					...
					<div class="w3l-table-info agile_info_shadow">
						...
						<table id="table-two-axis" class="two-axis">
							...
							<tbody>
								<?php
								$count=1;
								$sel_query="SELECT * FROM cargo where customer='{$customer}' ORDER BY cargo_id DESC; ";
								...
								while($row = mysqli_fetch_assoc($result)) 
									{ ?>
										<tr>
											...
											<td><a href="pay.php?id=<?php echo $row["cargo_id"]; ?>"class="btn btn-success"> <i class="fa fa-money"></i> Pay</a></td>
										</tr>
										<tr>
											<?php $count++; } ?>
										</tbody>

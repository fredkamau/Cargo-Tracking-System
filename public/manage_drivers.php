	...
	<div class="wthree_agile_admin_info">
			...
			<!-- /inner_content-->
				...
				<div class="w3l-table-info agile_info_shadow">
				  <!-- <h3><button class="btn btn-success"><a href="3">Add Driver</a></button></h3> -->
				   <input type="text" id="myInput"  placeholder="Sort..." title="Type here">


				   <button type="button" class="btn btn-info btn-flat btn-pri " ><i class="fa fa-print" aria-hidden="true" ></i><a href="print_drivers.php" class="btn-info"><i class="fa fa-print" aria-hidden="true" ></i>Print report</a>
                </button>
				  <div class="button">
							<p class="btnText">+ Driver</p>
							<div class="btnTwo">
							  <p class="btnText2"><a href="add_driver.php">ADD!</a></p>
							</div>
				  ...
				  <table id="table-two-axis" class="two-axis">
					...
					<tbody id="myTable">
						<?php
    $count=1;
   $sel_query="SELECT * FROM driver  ORDER BY driver_id DESC; ";
   ...
   while($row = mysqli_fetch_assoc($result)) 
   	{ ?>
				  <tr>
					...
					<td><?php echo $row["at_work"] ; ?></td>
					<td><?php echo $row["trn_date"] ; ?></td>
					
					
					<td><a href="delete_driver.php?id=<?php echo $row["driver_id"]; ?>"class="btn btn-warning"> <i class="fa fa-minus"></i> Remove</a></td>
				  </tr>
				  <tr>
				 <?php $count++; } ?>
				</tbody>

    ...
    $count=1;
   $sel_query="SELECT * FROM cargo where driver='{$driver}' and cleared=1 ORDER BY cargo_id DESC; ";
   ...
   while($row = mysqli_fetch_assoc($result)) 
   	{ ?>
				  <tr>
					...
					<td><a href="location_update.php?id=<?php echo $row["cargo_id"]; ?>"class="btn btn-warning"> <i class="fa fa-globe"></i> Location</a></td>

					<td><a href="fullfill_order.php?id=<?php echo $row["cargo_id"]; ?>"class="btn btn-warning"> <i class="fa fa-tick"></i> Fullfil</a></td>

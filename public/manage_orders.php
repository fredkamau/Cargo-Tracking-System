  ...
  <div class="wthree_agile_admin_info">
      ...
      <!-- /inner_content-->
        ...
        <div class="w3l-table-info agile_info_shadow">
         ...
         <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search.." title="Type in a name" class="noPrint">

<button type="button" class="btn btn-info btn-flat btn-pri " ><i class="fa fa-print" aria-hidden="true" ></i><a href="print_orders.php" class="btn-info"><i class="fa fa-print" aria-hidden="true" ></i>Print report</a>
                </button>
...
<td><?php echo  $count ; ?></td>
          ...
          <td id="noPrint"><a href="delete_orders.php?id=<?php echo $row["cargo_id"]; ?>"class="btn btn-warning"> <i class="fa fa-trash"></i> Remove</a></td>
          </tr>
          <tr>
         <?php $count++; } ?>
        </tbody>
